...
<script>
    ...
    */
    ...
    document.getElementById('btn_Agregar01').addEventListener("click", function() {
        var btn_Agregar01 = document.getElementById('btn_Agregar01');
        btn_Agregar01.disabled = true;
        ...
        el.innerHTML = `
                    ...
                    <button type="button" class="btn btn-primary" id="btn_Agregar`+id+`">Agregar</button>
        ...
        document.getElementById('btn_Agregar'+id).addEventListener("click", function() {
            var btn_Agregar = document.getElementById('btn_Agregar'+id);
            ...
            $(document).on('click', '#btn_Borrar01', function() {

                $(this).closest('#cont_Tabla01').remove();
            });
