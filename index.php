...
<body>
    ...
    <h1 id="txt_CambiarTXT">Texto para cambiar</h1>
    <button id="btn_CambiarTXT"> Cambiar texto con DB</button>
...
<script>
    ...
    */
    ...
    document.getElementById('btn_Agregar01').addEventListener("click", function() {
        ...
        el.innerHTML = `
                    <div class="final-block">Block One ` + id + `</div>
...
<script type="text/javascript">
    $(document).on('click', '#btn_CambiarTXT', function() {
        $.ajax({
            type: 'POST',
            url: 'php/select.php',
            data: {},
            success: function(data) {
                ...
                console.log(data);
                $('#txt_CambiarTXT').html(json[0].nombre);
